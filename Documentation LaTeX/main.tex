...
\begin{center}\includegraphics[width=\textwidth]{Documentation LaTeX/response.png}\\\small{Figure 4: Tone Control Response}\end{center}
\begin{center}\includegraphics[width=0.7\textwidth]{Documentation LaTeX/sch_tone.png}\\\small{Figure 5: Schematic - Tone Control}\end{center}
