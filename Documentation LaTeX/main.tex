...
\begin{center}
    ...
    \small{Figure 3: 12AX7 Characteristics}
\end{center}
...
\begin{center}\includegraphics[width=0.9\textwidth]{Documentation LaTeX/sch_output.png}\\\small{Figure 7: Schematic - Output Stage}\end{center}
\tab The values of potentiometers and resistances were decided so as to give us a master volume factor between 0 to about 0.04.
...
\begin{center}\includegraphics[width=0.9\textwidth]{Documentation LaTeX/sch_power.png}\\\small{Figure 8: Schematic - Power Management}\end{center}
